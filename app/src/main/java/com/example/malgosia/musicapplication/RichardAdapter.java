...
public class RichardAdapter extends ArrayAdapter<Album> {

    /**
     * Constructor for Richard Adapter
     *
     * @param context is the current context which is used to inflate the list layout file
     * @param richard is the list of Album objects which will populate the list
     */

    public RichardAdapter(Activity context, ArrayList<Album> richard) {
        super(context, 0, richard);
    }
