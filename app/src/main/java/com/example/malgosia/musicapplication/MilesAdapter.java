...
public class MilesAdapter extends ArrayAdapter<Album> {

    /**
     * Constructor for Miles Adapter
     *
     * @param context is the current context which is used to inflate the list layout file
     * @param miles   is the list of Album objects which will populate the list
     */
