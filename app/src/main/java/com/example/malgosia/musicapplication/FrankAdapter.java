...
public class FrankAdapter extends ArrayAdapter<Album> {
    /**
     * Constructor for Frank Adapter
     *
     * @param context is the current context which is used to inflate the list layout file
     * @param frank   is the list of Album objects which will populate the list
     */

    public FrankAdapter(Activity context, ArrayList<Album> frank) {
        super(context, 0, frank);
    }
